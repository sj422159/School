...
<!-- /cart.html /3.x [XR&CO'2014], Tue,  19:04:13  -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Shopping Cart || EduMart</title>
                                ...
                                <form action="#">
                                    <div class="table-content table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="EduMart-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                    <td class="EduMart-product-thumbnail"><a href="#"><img src="img/cart/cart1.jpg" alt=""></a></td>
                                                    <td class="EduMart-product-name"><a href="#">Aliquam lobortis est</a></td>
                                                    <td class="EduMart-product-price"><span class="amount">$70.00</span></td>
                                                ...
                                                <tr>
                                                    <td class="EduMart-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                    <td class="EduMart-product-thumbnail"><a href="#"><img src="img/cart/cart2.jpg" alt=""></a></td>
                                                    <td class="EduMart-product-name"><a href="#">Cras neque metus</a></td>
                                                    <td class="EduMart-product-price"><span class="amount">$60.50</span></td>
                                                    <td class="EduMart-product-quantity">
                                                        <input value="1" type="number">
                                                    </td>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-7 col-12">
                                    <span>Copyright &copy; Dizital.org. All right reserved.Created by <a href="#">EduMart</a></span>
                                </div>
